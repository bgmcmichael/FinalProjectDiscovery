...
//        ArrayList<UserPlaceholder> userBoxList = container.UserPlaceholderList;
    ...
    public void createDemo() {
        ...
        //MONDAY
        Event event = new Event("work", monday.plusHours(9), monday.plusHours(17), ZoneId.systemDefault().toString(), "Casa de Waffle", false, John);
        events.save(event);
        ...
        events.save(event);
        //SATURDAY
        event = new Event("work", saturday.plusHours(9), saturday.plusHours(17), ZoneId.systemDefault().toString(), "Casa de Waffle", false, John);
        events.save(event);
        //SUNDAY
        event = new Event("work", sunday.plusHours(9), sunday.plusHours(17), ZoneId.systemDefault().toString(), "Casa de Waffle", false, John);
        events.save(event);
